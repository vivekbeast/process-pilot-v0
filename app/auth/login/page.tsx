...
import { Eye, EyeOff, User, Lock, CheckCircle2, AlertCircle, LogIn, Sparkles } from "lucide-react";
              ...
              <div className="px-8 py-8">
                ...
                <form onSubmit={handleLogin} className="space-y-6 text-black">
                  ...
                  <div className="text-right">
                    <Link href="/auth/forgot-password" className="text-sm text-amber-600 hover:text-amber-700 hover:underline transition-colors font-medium">
                ...
                <div className="text-center mt-8 pt-6 border-t border-gray-100">
                  <p className="text-sm text-gray-600">
                    ...
                    <Link href="/auth/signup" className="font-semibold text-amber-600 hover:text-amber-700 hover:underline transition-colors">
                      Create one here
                    </Link>
                  </p>
