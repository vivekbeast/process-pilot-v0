        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 py-8  gap-12 items-center">
          ...
          <div className="text-center space-y-6">
            <div className="inline-flex items-center bg-gradient-to-r from-amber-100 to-orange-100 border border-amber-200 rounded-full px-4 py-2 text-sm font-medium text-amber-800 mb-4">
              ...
              Join ProcessPilot Today
            </div>
            
       
{/*             
            <p className="text-xl text-gray-600 leading-relaxed">
              Join thousands of manufacturers who have streamlined their operations with ProcessPilot. 
              Create your account in minutes and transform your production workflow today.
            </p>
          ...
          <div className="w-full max-w-md mx-auto">
            <div className="bg-white shadow-2xl rounded-2xl border border-gray-100 overflow-hidden">
              ...
              <div className="bg-gradient-to-r from-slate-600 to-slate-700 px-8 py-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300 text-sm">Get started with ProcessPilot</p>
                  </div>
                </div>
              </div>
              ...
              <div className="px-8 py-8">
                ...
                <form onSubmit={handleRegister} className="space-y-6 text-gray-900">
                  {/* Login ID Field */}
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="Choose your unique Login ID"
                        required
                        minLength={6}
                        maxLength={12}
